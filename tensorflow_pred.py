...
model.fit(x=batch("train"), epochs=5, steps_per_epoch=500, validation_data=batch("val"), validation_batch_size=100, validation_steps=5, callbacks=[tensorboard_callback])
model.save("model")